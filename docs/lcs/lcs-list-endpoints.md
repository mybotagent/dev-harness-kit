...
See the LCS UX proposal (issue #455, branch `feat/lcs-ux-proposal`) for the
design rationale and acceptance criteria. The proposal explores the four
gaps (router, summaries, discovery, reserved-URI honesty) and the
recommended merge order; the list endpoints on this page are Gap 3.
