...
```bash
$ open docs/lcs/lcs-usage.html   # full HTML reference (English)
$ open docs/lcs/lcs-usage.ko.html # 동일한 문서 (한국어)
```
...
2. **This page** (`docs/home/00-index.md`) — the why + value
...
Authored at `docs/home/00-index.md` in worktree `.worktrees/lcs-usage-html`, off
`origin/main @ 6bd1073`. Korean version: [`docs/home/00-index.ko.md`](00-index.ko.md).
HTML version: [`docs/home/00-index.html`](00-index.html). Back to [`../../README.md`](../../README.md).
