...
```bash
$ open docs/lcs/lcs-usage.html   # 전체 HTML 참조 (English)
...
2. **이 페이지** (`docs/home/00-index.ko.md`) — 왜 + 가치
...
워크트리 `.worktrees/lcs-usage-html`의 `docs/home/00-index.ko.md`에서 작성,
`origin/main @ 6bd1073`에서 분기. 영어 원본: [`docs/home/00-index.md`](00-index.md).
HTML 버전: [`docs/home/00-index.html`](00-index.html). [`../../README.md`](../../README.md)로 돌아가기.
