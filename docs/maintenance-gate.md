...
- **Pass** if (a) the PR touches no production path, (b) the PR also
  touches a `docs/` file (excluding `docs/STAGES.md` and
  `docs/REPOSITORY-MAP.md`, which are auto-managed), or (c) the PR
...
- `docs/STAGES.md` §7 — the pipeline-stage description.