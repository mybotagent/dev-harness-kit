...
- `docs/planning/PROPOSAL-IMPLEMENTATION-PLAN.md` (본 문서) — 모든 신규 모듈의 상위 참조
...
4. `docs/architecture/RUNTIME-PORTABILITY.md` exists
...
| `docs/stages/STAGES.md` | MOD (add "valuate" stage row) | +10 |
