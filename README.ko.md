...
| Tier 3 — 전문/비정기 | 동작을 평가하거나 자산을 복구하거나 리포트를 발행하거나 하네스를 유지보수할 때 | `eval`, `evaluate`, `valuate`, `research`, `interview`, `proposal`, `docs-maintenance`, `llm-refresh`, `prune-propose`, `harness-audit` |
