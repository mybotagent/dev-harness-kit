...
/dev-kit:ci-setup                # install dev-kit CI templates (workflows + hooks + scripts) into target repo
...
├── tests/                 # 117 tests (pytest) — naming, smoke, state, hooks, team-hooks, ci-setup
