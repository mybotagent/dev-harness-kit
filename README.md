...
[![Version](https://img.shields.io/badge/version-0.3.23-blue)](.claude-plugin/plugin.json)
...
🚀 **v0.3.23 — 44 skills shipped across 14 categories, 630 pytest collected (628 passed + 2 skipped), 12 eval cases live. Ongoing: per-skill drift audit, slop-detector v2 (multi-tier scan, 100+ patterns), Eval case expansion, template refresh.**
